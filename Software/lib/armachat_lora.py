...
_RH_RF95_SYNC_WORD = const(0x39)
_RH_RF95_REG_INVERTIQ = const(0x33)
_RH_RF95_REG_INVERTIQ2 = const(0x3b)
...
class RFM9x:
    ...
    def __init__(
        ...
        *,
        ...
        #self._write_u8(_RH_RF95_SYNC_WORD, 0x2B)   # sync word MESHTASTIC
        #self._write_u8(_RH_RF95_REG_INVERTIQ, 0x27) #disableInvertIQ
        #self._write_u8(_RH_RF95_REG_INVERTIQ2, 0x1d)
        #explicitHeaderMode
        #self._write_u8(_RH_RF95_REG_1D_MODEM_CONFIG1,(self._read_u8(_RH_RF95_REG_1D_MODEM_CONFIG1)) & 0xfe)
        #implicitHeaderMode
        #self._write_u8(_RH_RF95_REG_1D_MODEM_CONFIG1,(self._read_u8(_RH_RF95_REG_1D_MODEM_CONFIG1)) | 0x01)
    ...
    def spreading_factor(self, val: Literal[6, 7, 8, 9, 10, 11, 12]) -> None:
        ...
        if val == 6:
            self.detection_optimize = 0xc5 #old value only 5
        else:
            self.detection_optimize = 0xc3 #old value only 3
