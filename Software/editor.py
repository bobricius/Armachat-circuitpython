...
GUI = True
line = ["#Solve quadratic equation", "a=1.0", "b=8.0","c=12.0", "d=(b**2)-(4*a*c)", "s1=(-b-sqrt(d))/(2*a)","s2=(-b+sqrt(d))/(2*a)", "print('S1:{0}'.format(s1))", "print('S2:{0}'.format(s2))"]
...
#                 goToSleep()
        ...
        if keys:
            ...
            if keys == "ent" and line == "":
                ...
                if editLine<8 :editLine=editLine+1
        ...
        if displayRefresh==True:
            ...
            EditorScreen[0].text="'Quad_equation.py' "+str(editLine)+":"+str(cursor)
...
EditorScreen = SimpleTextDisplay(display=display,font=font,text_scale=1,
                                 colors=(SimpleTextDisplay.RED, SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK,
                                         SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK, SimpleTextDisplay.BLACK,
                                         SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK,SimpleTextDisplay.BLACK))
...
EditorScreen[0].background_color=0xFF0000
EditorScreen[0].color=SimpleTextDisplay.WHITE
...
while True:
    ...
    print("\033[2J",end="")
    print("\033]0;Python Programmable Calculator\033\\",end="")
    print ("... Program start ...")
    print (text)
